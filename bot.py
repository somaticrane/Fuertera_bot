...
# Connessione al database (crea il file users.db se non esiste)
conn = sqlite3.connect('C:/Users/fabio/Desktop/Fuerterabot_eng/users.db', check_same_thread=False)
cursor = conn.cursor()
...
def register_user(user_id, username):
    ...
    if cursor.fetchone() is None:
        # Se non esiste, aggiungi un nuovo record
...
def send_credit(message, amount):
    ...
    # Reimposta lo stato e cancella i dati temporanei
